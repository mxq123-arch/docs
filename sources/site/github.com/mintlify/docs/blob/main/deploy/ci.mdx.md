# Source: https://github.com/mintlify/docs/blob/main/deploy/ci.mdx
...
[History](https://github.com/mintlify/docs/commits/main/deploy/ci.mdx)

History

424 lines (359 loc) · 7.26 KB
...
[Raw](https://github.com/mintlify/docs/raw/refs/heads/main/deploy/ci.mdx)
...
<table><tbody><tr><th>title</th><td>CI checks</td></tr><tr><th>description</th><td>Automate documentation quality checks in your CI/CD pipeline with broken link detection, linting, grammar validation, and build previews.</td></tr><tr><th>keywords</th><td><table><tbody><tr><th><div dir="auto">continuous integration</div></th><th><div dir="auto">CI/CD</div></th><th><div dir="auto">checks</div></th><th><div dir="auto">Vale</div></th><th><div dir="auto">linter</div></th></tr></tbody></table></td></tr></tbody></table>

\[Pro and Enterprise plans\]([https://mintlify.com/pricing?ref=docs-ci](https://mintlify.com/pricing?ref=docs-ci)) include CI checks for GitHub repositories.
...
To begin, follow the steps on the [GitHub](https://github.com/mintlify/docs/blob/main/deploy/github) page.

## Configuration

Configure the CI checks enabled for a deployment by navigating to the [Add-ons](https://app.mintlify.com/products/addons) page of your dashboard. Enable the checks that you want to run.
...
Similar to how the [CLI link checker](https://github.com/mintlify/docs/blob/main/cli/commands#mint-broken-links) works on your local machine, the broken link CI check automatically searches your documentation content for broken internal links between pages within your site. It does not check external links to other websites.
...
For security reasons, automatically downloading packages that aren't from the \[Vale package registry\]([https://vale.sh/explorer](https://vale.sh/explorer)) is \*\*not\*\* supported.
...
Do not place \`{/\* vale off \*/}\` or similar MDX expression comments as direct children of a JSX component between sibling elements. For example, between two \`\` elements inside a \`\` component.
