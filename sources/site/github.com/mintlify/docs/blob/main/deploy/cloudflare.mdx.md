# Source: https://github.com/mintlify/docs/blob/main/deploy/cloudflare.mdx
...
[History](https://github.com/mintlify/docs/commits/main/deploy/cloudflare.mdx)

History

183 lines (137 loc) · 7.47 KB
...
[Raw](https://github.com/mintlify/docs/raw/refs/heads/main/deploy/cloudflare.mdx)
...
<table><tbody><tr><th>title</th><td>Deploy at a subpath with Cloudflare Workers</td></tr><tr><th>sidebarTitle</th><td>Cloudflare</td></tr><tr><th>description</th><td>Deploy your Mintlify documentation at a subpath on your domain using Cloudflare Workers with step-by-step setup and DNS configuration.</td></tr><tr><th>keywords</th><td><table><tbody><tr><th><div dir="auto">Cloudflare Workers</div></th><th><div dir="auto">subpath routing</div></th><th><div dir="auto">reverse proxy setup</div></th><th><div dir="auto">Worker configuration</div></th></tr></tbody></table></td></tr><tr><th>boost</th><td>3</td></tr></tbody></table>
...
Replace \`\[SUBDOMAIN\]\` with your unique subdomain, \`\[YOUR\_DOMAIN\]\` with your website's base URL, and \`/docs\` with your desired subpath if different.
...
Add your domain both with and without \`[www.\`](http://www.`) prepended.
