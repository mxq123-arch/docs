# Source: https://github.com/mintlify/docs/blob/main/deploy/multi-repo.mdx
...
[History](https://github.com/mintlify/docs/commits/main/deploy/multi-repo.mdx)

History

211 lines (149 loc) · 9.63 KB
...
[Raw](https://github.com/mintlify/docs/raw/refs/heads/main/deploy/multi-repo.mdx)
...
<table><tbody><tr><th>title</th><td>Multi-repository deployments</td></tr><tr><th>description</th><td>Combine multiple Git repositories into one Mintlify site, with a dedicated URL path for each source repo's content and navigation.</td></tr><tr><th>keywords</th><td><table><tbody><tr><th><div dir="auto">multi-repo</div></th><th><div dir="auto">multiple repositories</div></th><th><div dir="auto">git sources</div></th><th><div dir="auto">url path</div></th></tr></tbody></table></td></tr></tbody></table>

Multi-repository deployments are available on \[Enterprise plans\]([https://mintlify.com/pricing?ref=multi-repo](https://mintlify.com/pricing?ref=multi-repo)).
...
Click \*\*Add repository\*\*. Select the repository, branch, and any required Git provider-specific fields (GitHub or GitLab).
