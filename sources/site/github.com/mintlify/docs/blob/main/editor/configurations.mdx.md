# Source: https://github.com/mintlify/docs/blob/main/editor/configurations.mdx
...
[History](https://github.com/mintlify/docs/commits/main/editor/configurations.mdx)

Open commit details

History

198 lines (133 loc) · 8.77 KB
...
[Raw](https://github.com/mintlify/docs/raw/refs/heads/main/editor/configurations.mdx)
...
<table><tbody><tr><th>title</th><td>Configurations</td></tr><tr><th>description</th><td>Edit site branding, appearance, navigation, and feature settings from the Configurations panel in the Mintlify web editor, with real-time team sync.</td></tr><tr><th>keywords</th><td><table><tbody><tr><th><div dir="auto">editor</div></th><th><div dir="auto">configurations</div></th><th><div dir="auto">settings</div></th><th><div dir="auto">branding</div></th><th><div dir="auto">theme</div></th></tr></tbody></table></td></tr><tr><th>boost</th><td>3</td></tr></tbody></table>
...
To open the panel, click the configurations icon in the editor toolbar.

[![Configurations menu in the editor.](https://github.com/mintlify/docs/raw/main/images/editor/configurations-light.png)](https://github.com/mintlify/docs/blob/main/images/editor/configurations-light.png)

[![Configurations menu in the editor.](https://github.com/mintlify/docs/raw/main/images/editor/configurations-dark.png)](https://github.com/mintlify/docs/blob/main/images/editor/configurations-dark.png)

The panel groups settings into sections that map to the top-level properties in your [`docs.json`](https://github.com/mintlify/docs/blob/main/organize/settings).
...
- **Logo**: Your brand logo. Upload PNG or JPG files. Set separate light and dark versions and an optional click-through URL. To use an SVG logo, add the file to your repository and reference its path in your [`docs.json`](https://github.com/mintlify/docs/blob/main/organize/settings-appearance#logos).
...
- **Theme**: Choose a [theme](https://github.com/mintlify/docs/blob/main/customize/themes) for your site's overall appearance.
...
[![Redirects menu in the editor.](https://github.com/mintlify/docs/raw/main/images/editor/redirects-light.png)](https://github.com/mintlify/docs/blob/main/images/editor/redirects-light.png)

[![Redirects menu in the editor.](https://github.com/mintlify/docs/raw/main/images/editor/redirects-dark.png)](https://github.com/mintlify/docs/blob/main/images/editor/redirects-dark.png)
